...
export const Card = () => {
    return (
        <Link href={"/cursos/jfsldfjlj"} className='hover:no-underline'>
            <article className='flex flex-col gap-4 p-2 rounded sm:hover:bg-primary'>
                ...
                />
                <h4 className='line-clamp-2 font-extrabold text-lg'>API Rest, Node e Typescript: #00 - Apresentação do curso, tecnologias usadas e muito mais</h4>
